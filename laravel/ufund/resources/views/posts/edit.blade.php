            ...
            <div id="ui">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="col-lg-12">
                        ...
                        <input type="number" name="phoneNumber" class="form-control round_input" placeholder="Enter your phone number.." value="{{$post->phone_number}}">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="number" name="rqAmount"  class="form-control round_input" placeholder="Enter donation amount.." value="{{$post->donation_amount}}">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="date" name="date" class="form-control round_input" placeholder="Enter required date.." value="{{$post->required_date}}">
                        <br>
                    </div>
                ...
                <input type="submit" name="Submit" value="Update" class="btn btn-primary btn-block long_button">
